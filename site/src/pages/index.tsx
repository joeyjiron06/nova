...
function StoreLine({ name }: { name: string }) {
  return (
    <span>
      ...
      <span className={tok.fn}>{name}</span>
      <span className={tok.plain}>(),</span>
    </span>
  );
}
    ...
    <section className="mx-auto grid w-full max-w-6xl flex-1 items-center gap-12 px-6 py-20 lg:grid-cols-2 lg:gap-16">
      <div className="flex flex-col items-start gap-6">
        <h1 className="text-4xl font-bold tracking-tight text-balance sm:text-5xl">
          A <span className="font-light italic">tiny</span> cache that runs anywhere.
        </h1>
        ...
        <div className="flex flex-wrap items-center gap-3">
          <a
            href="/docs"
            className={buttonVariants({ variant: "primary", className: "px-5 py-2.5" })}
          >
            Get started
          </a>
          <a
            href="https://github.com/joeyjiron/nova"
            className={buttonVariants({ variant: "outline", className: "px-5 py-2.5" })}
          >
            View on GitHub
          </a>
        </div>
          ...
          <article className="bg-fd-card hover:border-fd-foreground/20 group relative flex flex-col gap-5 overflow-hidden rounded-2xl border p-7 transition-colors sm:col-span-2 lg:col-span-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-fd-muted-foreground max-w-md text-pretty">
                ...
                afternoon. Swap the backend without touching a single call
                site.
              </p>
            </div>
